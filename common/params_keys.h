...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DrivingModel", {PERSISTENT, STRING, "firehose_default", "firehose_default", 1}},
    {"DrivingModelName", {PERSISTENT, STRING, "Firehose (Default)", "Firehose (Default)", 1}},
    ...
    {"MinimumLaneChangeSpeed", {PERSISTENT, FLOAT, "20", "20", 2}},
